...
const HeaderAction = () => {
    ...
    return (
        <div className={"flex items-center gap-6 sm:gap-12"}>
            ...
            <div className={"relative"}>
                <button onClick={handleOpen} type={"button"} aria-label={"user avatar"} className={`flex justify-center items-center w-6 h-6 sm:w-12.5 sm:h-12.5 shrink-0 ${isOpen ? "ring-2 ring-orange-500 rounded-full" : ""}`}>
